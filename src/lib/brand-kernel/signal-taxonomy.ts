...
export type GraphArea = keyof Omit<BrandGraph, "overallConfidence">;
...
export const SIGNAL_TAXONOMY: Record<string, SignalDefinition> = {
  craftsmanship: {
    ...
    graphAreas: ["identity", "beliefs", "differentiators"],
  },
  ...
  durability: {
    ...
    graphAreas: ["trustSignals", "positioning"],
  },
