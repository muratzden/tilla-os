...
export const conflictRegistry: ContradictionRule[] = [
  {
    ...
    weight: 0.95,
    reason:
      "Premium positioning conflicts with lowest-price positioning.",
  },
  {
    ...
    weight: 0.98,
    reason:
      "Handcrafted quality conflicts with mass production.",
  },
  {
    ...
    weight: 0.92,
    reason:
      "Long-term trust conflicts with aggressive discounting.",
  },
];