...
export const deOutputPack: OutputPack = {
  ...
  auditText: {
  violations: {
    forbiddenDirection: "Inhalt signalisiert eine verbotene Markenrichtung: {{value}}",
  },
  recommendations: {
    removeOrReframe:
      "Entferne oder formuliere Inhalte neu, die {{value}} nahelegen.",
    strengthenBrandSignal:
      "Stärke das Markensignal rund um {{value}}.",
  },
  driftAnalysis: {
    aligned:
  ...
  governanceSignals: {
    ...
    consistencyNotStable: "Der Markenkonsistenztrend ist nicht stabil: {{value}}.",
  },
},
  ...
  camera: {
    realisticEditorialProductPhotography: "realistische editoriale Produktfotografie",
  },
...
narrative: {
  ...
  quietPower: {
    ...
    productLanguage: {
      ...
      emotion:
        "Nichts Überflüssiges; nur Funktion, Balance und Autorität.",
    },
  },
  ...
  default: {
    ...
    materials: {
      ...
      tiana: {
        label: "Tiana",
        description: "Raffiniertes Leder mit kontrolliertem Quiet-Luxury-Gefühl.",
      },
      kansas: {
        label: "Kansas",
        description: "Kräftiges, substanzvolles Leder mit funktionalem Charakter.",
      },
      crazy: {
        label: "Crazy",
        description: "Ausdrucksstarkes Leder, das mit der Zeit Spuren, Patina und persönlichen Charakter entwickelt.",
      },
    },
    colors: {
      black: {
      ...
      taba: {
        label: "Cognac",
        description: "Ein warmer Ton, der Handwerk und natürlichen Ledercharakter betont.",
      },
      brown: {
        label: "Braun",
  ...
  briefcase: {
    label: "Aktentasche",
    description: "Eine handgefertigte Leder-Aktentasche, die Ordnung, Vertrauen und langfristige Nutzung vermittelt.",
  },
  tote: {
    label: "Tragetasche",
    description: "Eine schlichte und funktionale Ledertasche für den täglichen Gebrauch.",
  },
  messenger: {
    label: "Umhängetasche",
    description: "Eine charaktervolle Schultertasche für Bewegung und praktisches tägliches Tragen.",
  },
  wallet: {
    label: "Geldbörse",
    description: "Eine persönliche Leder-Geldbörse, die durch Nutzung und Berührung Charakter gewinnt.",
  },
  belt: {
    label: "Gürtel",
    description: "Ein schlichter, robuster und zeitloser Ledergürtel für langfristige Nutzung.",
  },
  notebook_cover: {
    label: "Notizbuchhülle",
    description: "Eine handgefertigte Lederhülle, die das Schreiben und Notieren begleitet.",
  },
  guitar_strap: {
    label: "Gitarrengurt",
    description: "Ein handgefertigter Leder-Gitarrengurt für Bühne, Studio und lange Sessions.",
  },
},
...
channels: {
  website: {
    label: "Webseite",
    description: "Der primäre Verkaufskanal, in dem das Produkt klar, vertrauenswürdig und kaufbereit präsentiert werden muss.",
  },
  instagram: {
    label: "Instagram",
    description: "Ein visueller sozialer Kanal, der Atmosphäre, Details und handwerkliches Gefühl vermittelt.",
  },
  etsy: {
    label: "Etsy",
    description: "Ein internationaler Marktplatz, auf dem handgefertigte und personalisierbare Produkte erwartet werden.",
  },
  amazon: {
    label: "Amazon",
    description: "Ein Marktplatz, der eine klare, vertrauensorientierte Produktpräsentation für schnelle Entscheidungen erfordert.",
  },
  wholesale: {
    label: "Großhandel",
    description: "Ein Kanal für geschäftliche oder größere Bestellungen, bei dem Klarheit, Vertrauen und Produktionskapazität wichtig sind.",
  },
},
...
environments: {
  studio: {
    label: "Studio",
    description: "Eine kontrollierte Umgebung mit sauberem Licht, klarer Komposition und sichtbaren Produktdetails.",
  },
  workshop: {
    label: "Werkstatt",
    description: "Eine Umgebung, die Herstellungsprozess, Handarbeit und echte Produktionsspuren sichtbar macht.",
  },
  library: {
    label: "Bibliothek",
    description: "Eine ruhige, intellektuelle und zeitlose Premium-Atmosphäre.",
  },
  office: {
    label: "Büro",
    description: "Eine Umgebung, die professionelle Nutzung, Ordnung und Vertrauen hervorhebt.",
  },
  home: {
    label: "Zuhause",
    description: "Eine Umgebung, die das Produkt im Alltag, in persönlichen Ritualen und warmer Nutzung zeigt.",
  },
},
...
emotions: {
  confidence: {
    label: "Vertrauen",
    description: "Das Gefühl, dass das Produkt solide, ehrlich und für langfristige Nutzung gemacht ist.",
  },
  calm: {
    label: "Ruhe",
    description: "Ein kontrolliertes, ausgewogenes Premium-Gefühl ohne unnötige Lautstärke.",
  },
  heritage: {
    label: "Tradition",
    description: "Ein Gefühl von Handwerk, Herkunft und Beständigkeit über die Zeit.",
  },
  craftsmanship: {
    label: "Handwerkskunst",
    description: "Das Gefühl von Handarbeit, Materialwissen und sichtbarem Produktionscharakter.",
  },
  exclusivity: {
    label: "Exklusivität",
    description: "Ein Gefühl von Unterscheidung, Personalisierung und Distanz zur Massenproduktion.",
  },
},
},
semantic: {
    quiet_luxury: {
      label: "Ruhiger Luxus",
      description: "Zurückhaltendes, raffiniertes und hochwertiges Markengefühl",
    },
    artisan_heritage: {
      label: "Handwerkstradition",
      description: "Menschliche Arbeit, Meisterschaft und traditionelle Herstellung",
    },
    executive_artisan: {
      label: "Handwerkliche Exzellenz",
      description: "Professionelle Ernsthaftigkeit verbunden mit Handwerkskunst",
    },
    quiet_power: {
      label: "Stille Kraft",
    ...
    private_library: {
      ...
      description: "Ruhige, intellektuelle und vertrauensbildende Innenraumszene",
    },
    private_study: {
    ...
    executive_office: {
      ...
      description: "Professionelle, kontrollierte und vertrauensbildende Büroszene",
    },
    artisan_workshop: {
      label: "Raffinierte Handwerkswerkstatt",
      description: "Werkstattszene mit Handwerk, Material und menschlicher Arbeit",
    },
    minimal_gallery: {
      label: "Minimale Galerie",
      description: "Klare und reduzierte Galerieszene, die das Produkt hervorhebt",
    },
    editorial_product: {
      label: "Editoriales Produktfoto",
      description: "Aufnahmeart, die das Produkt mit magazinartiger Ästhetik zeigt",
    },
    editorial_hero: {
      label: "Premium Editorial Hero Komposition",
      description: "Starke, hochwertige und editoriale Komposition für das Hauptbild",
    },
    premium_editorial: {
      label: "Premium Editorial Komposition",
      description: "Raffinierte, hochwertige Komposition in Publikationsqualität",
    },
	hero_composition: {
  label: "Premium-Hero-Komposition",
  description: "Eine Komposition, die das Hauptprodukt mit starker, zurückhaltender und hochwertiger visueller Hierarchie präsentiert.",
},
leica_m11: {
  label: "Leica M11 Editorial-Fotografie",
  description: "Hochwertige, realistische und editoriale Produktfotografie.",
},
hasselblad_x2d: {
  label: "Hasselblad X2D Mittelformat-Fotografie",
  description: "Detailreiche, raffinierte und hochwertige Mittelformat-Bildqualität.",
},
phase_one: {
  label: "Phase One kommerzielle Luxusfotografie",
  description: "Hochwertige kommerzielle Produkt- und Luxusmarkenfotografie.",
},
canon_r5: {
  ...
  description: "Realistische, klare und professionelle Produktfotografie.",
    ...
    warnings: {
      ...
      consistencyWeakening:
        "Die Markenkonsistenz wird schwächer.",
    },
...
constitution: {
  ...
  recommendations: {
    forbiddenDirectionDetected:
      "Verbotene Markenrichtung erkannt.",
    corePrincipleConflict:
      "Konflikt mit einem zentralen Markenprinzip erkannt.",
    governancePassed:
      "Der Inhalt hat die Governance-Regeln bestanden.",
  },

  signals: {
    forbiddenDirectionDetected:
      "Verbotene Richtung erkannt.",
    corePrincipleConflict:
      "Konflikt mit einem Kernprinzip erkannt.",
    governancePassed:
      "Governance-Prüfung bestanden.",
  },
},
};
